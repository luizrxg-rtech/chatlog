            ...
            >
              {targets.map((item, index) => (
                  <motion.li
                      ...
                      className={`flex items-center ${index % 2 ? "justify-end" : "justify-start"}`}
                  >
                    <div className={`flex ${index % 2 && "flex-row-reverse"}`}>
                      <div className="min-w-12 min-h-12 w-12 h-12 bg-gradient-to-br from-gray-100 to-gray-300 rounded-full flex items-center justify-center">
                          <item.icon className={`w-6 h-6 ${index % 2 ? "text-primary-600" : "text-primary-500"}`}/>
                      </div>
                      <TriangleRightIcon
                        className={`
                          min-w-6 
                      ...
                      <div
                        className={
                          ...
                          ${index % 2 ? `
                            ...
                            to-primary-400
                          `} 
                          px-8 py-4 max-w-4xl relative
                        `}>
                        <p className="font-bold text-xl md:text-2xl text-gray-100">{item.text}</p>
                      </div>
                    </div>
                  </motion.li>
              ))}
